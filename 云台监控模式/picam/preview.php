<?php
   ...
   //Text labels here
   define('BTN_DOWNLOAD', '下载');
   define('BTN_DELETE', '删除');
   define('BTN_DELETE_CONFIRM', '你确定要删除这个文件吗?');
   define('BTN_CONVERT', 'Start Convert');
   define('BTN_DELETEALL', 'Delete All');
   define('BTN_DELETEALL_CONFIRM', '你确定要删除所有文件吗?');
   define('BTN_DELETESEL', '删除勾选');
   define('BTN_DELETESEL_CONFIRM', '你确定要删除勾选的文件吗?');
   define('BTN_SELECTALL', 'Select All');
   define('BTN_SELECTNONE', '取消勾选');
   define('BTN_GETZIP', '下载');
...
<html>
   ...
   <body>
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         <div class="container">
            <div class="navbar-header">
               <a class="navbar-brand" href="<?php echo ROOT_PHP; ?>"><span class="glyphicon glyphicon-chevron-left"></span>返回 - 云台控制监控</a>
            </div>
         </div>
      </div>
      ...
      <form action="preview.php" method="POST">
         ...
         <h1 style="font-size:20px;color:#777;" <?php echo pvDisplayStyle(''); ?>><?php echo TXT_FILES; ?>
         <button class='btn btn-primary' type='submit' name='action' value='selectNone'><?php echo BTN_SELECTNONE; ?></button>
         <button style="background-color:crimson;border-color:crimson;" class='btn btn-primary' type='submit' name='action' value='zipSel'><?php echo BTN_GETZIP; ?></button>
         ...
         if(count($thumbnails) == 0) echo "<p>没有视频/图片可以保存</p>";
         else {
