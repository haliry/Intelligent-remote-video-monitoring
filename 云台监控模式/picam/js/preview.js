...
function load_preview(thumbnail) {
	...
	if (mediaURL) {
		...
		if (fileExtension(mediaURL) == 'jpg') {
			...
			media_content = '<a href="' + mediaURL + '" target="_blank"><img src="' + mediaURL + '" style="width: 800px;"></a>';
		} else {
			...
			media_content = '<video style="width: 800px;" controls><source src="' + mediaURL + '" type="video/mp4">Your browser does not support the video tag.</video>';
		}
