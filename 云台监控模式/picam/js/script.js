...
ajax_status.onreadystatechange = function() {
  if(ajax_status.readyState == 4 && ajax_status.status == 200) {
    ...
    if(ajax_status.responseText == "ready") {
      setButtonState("video_button", false, "开启视频录制", "ca 1");
      setButtonState("image_button", false, "截取画面", "im");
      setButtonState("halt_button", false, "关闭摄像头", "ru 0");
      ...
      setButtonState("video_button", false, "停止视频录制", "ca 0");
      setButtonState("image_button", false, "截取画面", "im");
      setButtonState("halt_button", true, "关闭摄像头");
      ...
      setButtonState("video_button", true, "开启视频录制");
      setButtonState("image_button", true, "截取画面");
      setButtonState("halt_button", true, "关闭摄像头");
      document.getElementById("preview_select").disabled = false;
      ...
      setButtonState("video_button", true, "开启视频录制");
      setButtonState("image_button", true, "截取画面");
      setButtonState("halt_button", false, "开启摄像头", "ru 1");
      document.getElementById("preview_select").disabled = false;
      document.getElementById("video_button").className = btn_class_p;
      document.getElementById("image_button").className = btn_class_p;
      halted = 1;
